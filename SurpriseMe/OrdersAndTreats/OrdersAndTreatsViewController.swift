...
extension OrdersAndTreatsViewController : UITableViewDataSource{
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        case 0: return  CurrentUser.shared!.myOrders.count
        case 1: return CurrentUser.shared!.myTreats.count
        default:
            return 1
        }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            cell.order = CurrentUser.shared!.myOrders[indexPath.row]
            cell.idLabel.text = CurrentUser.shared!.myOrders[indexPath.row].id
            //to do: don't forget to make the calculation ahead.
            cell.priceLabel.text = "\(CurrentUser.shared!.myOrders[indexPath.row].price)"
            cell.dateLabel.text = CurrentUser.shared!.myOrders[indexPath.row].dateString
            cell.delegate = self
        ...
        case 1:
            ...
            cell.populate(treat: CurrentUser.shared!.myTreats[indexPath.row])
            cell.delegate = self
